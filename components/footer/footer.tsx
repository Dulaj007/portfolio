      ...
      <div className="flex-grow flex flex-col md:flex-row justify-between items-start px-6 pt-20 pb-16 md:px-16 md:pt-24 lg:px-24">
        ...
        <div className="flex flex-col items-start gap-y-6 md:items-end md:text-right mt-12 md:mt-0">
          ...
          <div className="flex flex-col items-start md:items-end gap-y-4">
            ...
            {/* Instagram */}
            <Link
              href="https://instagram.com/yasitha.dulaj/"
              target="_blank"
              className="animate-fade-up flex items-center gap-x-3 group text-red-600 hover:text-red-400  transition-all"
            >
              <svg
              ...
              <span className="text-base md:text-xl">Instagram</span>
              <svg
                viewBox="0 0 24 24"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
            ...
            {/* LinkedIn */}
            <Link
              href="https://linkedin.com/in/yasitha-dulaj/"
              target="_blank"
              className="animate-fade-up flex items-center gap-x-3 group text-red-600 hover:text-red-400  transition-all"
            >
              <svg
            ...
            {/* GitHub */}
            <Link
              href="https://github.com/YasithaDulaj"
              target="_blank"
              className="animate-fade-up flex items-center gap-x-3 group text-red-600 hover:text-red-400  transition-all"
            >
              <svg
